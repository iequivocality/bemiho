...
class BemihoUserInput:
    def __init__(self, group, member, output, content, firstpage, number_of_pages):
        self.group = group
        self.member = member
        self.output = output
...
class BemihoUserInputBuilder:
    ...
    def build(self):
        user_input = BemihoUserInput(self.group, self.member, self.output, self.content, self.firstpage, self.number_of_pages)
